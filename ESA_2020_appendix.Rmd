...
```
_Figure 3: The magnitude of among group differences, F- statistic, as a function of distance between plants in a common garden. Black dashed line shows median value, while coloured lines correspond to posterior samples of paramet estimates model. Vertical lines indicate the actual spacing in the common garden._  
